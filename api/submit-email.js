export default async function handler(req, res) {
    ...
    let groupId;
    if (source === 'free_stay_giveaway') {
        groupId = process.env.MAILERLITE_GROUP_GIVEAWAY;
    } else if (source === 'booking_intent') {
